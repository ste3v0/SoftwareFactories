...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Title(ISerializationContext context, Title semanticObject) {
		...
		feeder.accept(grammarAccess.getTitleAccess().getInfinitivLOWERCASE_WORDTerminalRuleCall_1_0(), semanticObject.getInfinitiv());
		feeder.finish();
	}
	...
	protected void sequence_Ziel_Wunsch(ISerializationContext context, Ziel_Wunsch semanticObject) {
		...
		feeder.accept(grammarAccess.getZiel_WunschAccess().getInfinitivLOWERCASE_WORDTerminalRuleCall_1_0(), semanticObject.getInfinitiv());
		feeder.finish();
	}
